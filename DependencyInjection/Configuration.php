    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $treeBuilder->getRootNode()
            ...
            ->children()
                ...
                ->arrayNode('health')
                    ->addDefaultsIfNotSet()
                    ->info('Readiness-probe cold-start resilience (see S3ObjectStoreHealthCheck).')
                    ->children()
                        ->integerNode('cold_start_attempts')
                            ->min(1)
                            ->defaultValue(3)
                            ->info('HeadBucket attempts before reporting unhealthy; absorbs a cold-connection blip on a freshly-started worker.')
                        ->end()
